...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='/home/intellhave/Work/Datasets/TINYIMAGENET200/',
    ...
    # Defining the model.
    in_channels, out_features = 3, 200
    if args.model == 'VGGBinaryConnect': #
        ...
        model = models.ResNet18(input_channels=3, imsize=64, output_dim=out_features)
